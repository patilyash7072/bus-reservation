...
import com.dss.bus_reservation.dto.HistoryDTO;
...
public class AdminLayout extends AppLayout {
    ...
    private SideNav getSideNav() {
        ...
        sideNav.addItem(
                new SideNavItem("Manage Buses", "/manage-bus", VaadinIcon.BUS.create()),
                new SideNavItem("Manage Routes", "/manage-route", VaadinIcon.ROAD.create()),
                new SideNavItem("Manage Stations", "/manage-station",
